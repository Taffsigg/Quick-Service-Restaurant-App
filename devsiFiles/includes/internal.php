...
<section class="content-header">
    <h1>
        <span class="fa fa-dashboard"></span> Internal Orders
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="?dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Internal Orders</li>
    </ol>
</section>
...
<script type="text/javascript">
	...
	function toggleStatusId(id){
		...
		if(x){
			$.post('ajax.php',{'toggle':'orders','tid':id},function(data){
				if(data==1){
